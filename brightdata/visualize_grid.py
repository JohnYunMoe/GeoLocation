...
## This script visualizes the grid points generated by generate_grid.py on an interactive map.
# ---------------------------------------------------------------------------
# BOUNDING BOXES SHOULD BE REPLACED MANUALLY WHENEVER IT'S UPDATED IN generate_grid.py — they are duplicated here for labeling purposes
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
# bounding boxes — same as generate_grid.py, used to label each point
# ---------------------------------------------------------------------------
EMIRATES = {
